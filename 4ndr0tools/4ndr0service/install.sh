...
# [4NDR0666OS]: Hardened Global Path to prevent /root/ context hijacking
...
while [[ $# -gt 0 ]]; do
    ...
    -h | --help)      echo "Usage: $0 [-n] [-u]"; exit 0 ;;
...
if [[ "${UNINSTALL}" == "true" ]]; then
    log_info "Initiating Scorch Protocol..."
