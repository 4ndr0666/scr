...
STYLING_MANIFEST = {
    ...
    "COCO_CAPITÁN": "Hand-written text on image, youth melancholy, warm analogue",
    ...
    "SØLVE_SUNDSBØ": "Technical post-digital body, scanner art, cold precision",
...
LIGHTING_PHYSICS_MANIFEST = {
    ...
    "chimera_lightbank_large": "Large softbox equivalent over strobe, very soft wrap",
...
# Skin topology — standalone for topo_pool used in builder and random gen
TOPO_COMPLETIONS = [
...
# Shutter / sync — standalone list referenced by builder and random gen
SHUTTER_COMPLETIONS = [
    ...
    "flash_sync_1_30_heavy_ambient",
    "flash_sync_1_8000_leaf_shutter",
    "rear_curtain_sync_motion_trail",
